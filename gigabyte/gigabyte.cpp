...
BOOL GetKey(wchar_t** ProductKey)
{
	...
	case PRODUCT_ULTIMATE:
		*ProductKey = L"YJJYR-666KV-8T4YH-KM9TB-4PY2W";
		break;
	case PRODUCT_HOME_BASIC:
		*ProductKey = L"2TY7W-H4DD4-MB62F-BD9C3-88TM6";
		break;
	case PRODUCT_HOME_PREMIUM:
		*ProductKey = L"3743C-T6892-B4PHM-JHFKY-4BB7W";
		break;
	case PRODUCT_PROFESSIONAL:
		*ProductKey = L"H9M26-6BXJP-XXFCY-7BR4V-24X8J";
		break;
	case PRODUCT_STARTER:
		*ProductKey = L"76MTG-QMQJQ-46DQR-CHRBB-7K3HD";
		break;
