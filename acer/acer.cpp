...
BOOL GetKey(wchar_t** ProductKey)
{
	...
	case PRODUCT_ULTIMATE:
		*ProductKey = L"FJGCP-4DFJD-GJY49-VJBQ7-HYRR2";
		break;
	case PRODUCT_HOME_BASIC:
		*ProductKey = L"MB4HF-2Q8V3-W88WR-K7287-2H4CP";
		break;
	case PRODUCT_HOME_PREMIUM:
		*ProductKey = L"VQB3X-Q3KP8-WJ2H8-R6B6D-7QJB7";
		break;
	case PRODUCT_PROFESSIONAL:
		*ProductKey = L"YKHFT-KW986-GK4PY-FDWYH-7TP9F";
		break;
	case PRODUCT_STARTER:
		*ProductKey = L"RDJXR-3M32B-FJT32-QMPGB-GCFF6";
		break;
