...
BOOL GetKey(wchar_t** ProductKey)
{
	...
	case PRODUCT_ULTIMATE:
		*ProductKey = L"4HMYB-6YHYT-TW2J6-FQBC3-6GBFW";
		break;
	case PRODUCT_HOME_BASIC:
		*ProductKey = L"6M78P-JJRQP-9C4RX-RPK7G-3VTH3";
		break;
	case PRODUCT_HOME_PREMIUM:
		*ProductKey = L"V3Y2W-CMF9W-PGT9C-777KD-32W74";
		break;
	case PRODUCT_PROFESSIONAL:
		*ProductKey = L"MPC38-VC8FK-TWPXH-TR3XV-T2Y4K";
		break;
	case PRODUCT_STARTER:
		*ProductKey = L"CYXM7-YHGFJ-K7HTJ-RYBBF-GXFMM";
		break;
