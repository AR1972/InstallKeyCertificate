...
BOOL GetKey(wchar_t** ProductKey)
{
	...
	case PRODUCT_ULTIMATE:
		*ProductKey = L"342DG-6YJR8-X92GV-V7DCV-P4K27";
		break;
	case PRODUCT_HOME_BASIC:
		*ProductKey = L"36T88-RT7C6-R38TQ-RV8M9-WWTCY";
		break;
	case PRODUCT_HOME_PREMIUM:
		*ProductKey = L"6RBBT-F8VPQ-QCPVQ-KHRB8-RMV82";
		break;
	case PRODUCT_PROFESSIONAL:
		*ProductKey = L"32KD2-K9CTF-M3DJT-4J3WC-733WD";
		break;
	case PRODUCT_STARTER:
		*ProductKey = L"36Q3Y-BBT84-MGJ3H-FT7VD-FG72J";
		break;
